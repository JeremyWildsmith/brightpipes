 ...
 */
function GameOverScreen2(width, height, screenController, score) {
 ...
 */
GameOverScreen2.prototype.update = function (deltaTime) {
 ...
 */
GameOverScreen2.prototype.correctLayout = function () {
 ...
 */
GameOverScreen2.prototype.draw = function (g, x, y) {
    this.correctLayout();
    ...
    text = "You failed to place a pipe !";
 ...
 */
GameOverScreen2.prototype.onMouseDown = function (location) {
 ...
 * @param {Vector} location Location of mouse cursor during event.
 */
GameOverScreen2.prototype.onMouseUp = function (location) {
    if (this.lastActiveControl !== null)
 ...
 */
GameOverScreen2.prototype.onMouseMove = function (location) {
 ...
 */
GameOverScreen2.prototype.onKeyDown = function(keyCode) {
