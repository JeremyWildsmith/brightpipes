 ...
 */
function GameOverScreen3(width, height, screenController, score) {
 ...
 */
GameOverScreen3.prototype.update = function (deltaTime) {
 ...
 */
GameOverScreen3.prototype.correctLayout = function () {
 ...
 */
GameOverScreen3.prototype.draw = function (g, x, y) {
    this.correctLayout();
    ...
    text = "You failed to fill all the drains !";
 ...
 */
GameOverScreen3.prototype.onMouseDown = function (location) {
 ...
 * @param {Vector} location Location of mouse cursor during event.
 */
GameOverScreen3.prototype.onMouseUp = function (location) {
    if (this.lastActiveControl !== null)
 ...
 */
GameOverScreen3.prototype.onMouseMove = function (location) {
 ...
 */
GameOverScreen3.prototype.onKeyDown = function(keyCode) {
