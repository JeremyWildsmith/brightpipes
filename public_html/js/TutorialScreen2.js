 ...
 */
function TutorialScreen2(width, height, screenController) {
    ...
    this.nextButton = new Button("Next", function() {screenController.setScreen(new TutorialScreen3(width, height, screenController));});
    this.backButton = new Button("Back", function() {screenController.setScreen(new TutorialScreen(width, height, screenController));});
 ...
 */
TutorialScreen2.prototype.update = function (deltaTime) {
 ...
 */
TutorialScreen2.prototype.correctLayout = function() {
 ...
 */
TutorialScreen2.prototype.draw = function (g, x, y) {
    this.correctLayout();
    
    g.font = "20px Trade Winds";
    g.fillText("Connect the pipes together to make", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y);
    g.fillText("a route for the water . Fill up all", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 25);
    g.fillText("of the drains with water to progress", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 50);
    g.fillText("through the game .", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 75);
 ...
 */
TutorialScreen2.prototype.onMouseDown = function(location) {
 ...
 * @param {Vector} location Location of mouse cursor during event.
 */
TutorialScreen2.prototype.onMouseUp = function(location) {
    if(this.lastActiveControl !== null)
 ...
 * @param {Vector} location Location of mouse cursor during event.
 */
TutorialScreen2.prototype.onMouseMove = function(location) {
 ...
 */
TutorialScreen2.prototype.onKeyDown = function(keyCode) {
