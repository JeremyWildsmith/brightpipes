 ...
 */
function TutorialScreen3(width, height, screenController) {
    ...
    this.nextButton = new Button("Next", function() {screenController.setScreen(new TutorialScreen4(width, height, screenController));});
    this.backButton = new Button("Back", function() {screenController.setScreen(new TutorialScreen2(width, height, screenController));});
 ...
 */
TutorialScreen3.prototype.update = function (deltaTime) {
 ...
 */
TutorialScreen3.prototype.correctLayout = function() {
 ...
 */
TutorialScreen3.prototype.draw = function (g, x, y) {
    this.correctLayout();
    
    g.font = "20px Trade Winds";
    g.fillText("Pipes cannot be placed on pumps ,", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y);
    g.fillText("drains , obstacles , and rusted", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 25);
    g.fillText("pipes . Water can still flow", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 50);
    g.fillText("through rusted pipes so use them", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 75);
    g.fillText("to your advantage !", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 100);
 ...
 */
TutorialScreen3.prototype.onMouseDown = function(location) {
 ...
 * @param {Vector} location Location of mouse cursor during event.
 */
TutorialScreen3.prototype.onMouseUp = function(location) {
    if(this.lastActiveControl !== null)
 ...
 * @param {Vector} location Location of mouse cursor during event.
 */
TutorialScreen3.prototype.onMouseMove = function(location) {
 ...
 */
TutorialScreen3.prototype.onKeyDown = function(keyCode) {
