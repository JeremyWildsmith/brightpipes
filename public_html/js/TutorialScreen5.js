 ...
 */
function TutorialScreen5(width, height, screenController) {
    ...
    this.nextButton = new Button("Next", function() {screenController.setScreen(new TutorialScreen6(width, height, screenController));});
    this.backButton = new Button("Back", function() {screenController.setScreen(new TutorialScreen4(width, height, screenController));});
 ...
 */
TutorialScreen5.prototype.update = function (deltaTime) {
 ...
 */
TutorialScreen5.prototype.correctLayout = function() {
 ...
 */
TutorialScreen5.prototype.draw = function (g, x, y) {
    this.correctLayout();
    
    g.font = "20px Trade Winds";
    g.fillText("You will constantly be given a new", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y);
    g.fillText("set of pipes . Water will start", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 25);
    g.fillText("flowing when a pipe is placed in", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 50);
    g.fillText("front of the pump or when four pipes", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 75);
    g.fillText("are placed .", this.TEXT_LOCATION.x, this.TEXT_LOCATION.y + 100);
 ...
 */
TutorialScreen5.prototype.onMouseDown = function(location) {
 ...
 * @param {Vector} location Location of mouse cursor during event.
 */
TutorialScreen5.prototype.onMouseUp = function(location) {
    if(this.lastActiveControl !== null)
 ...
 * @param {Vector} location Location of mouse cursor during event.
 */
TutorialScreen5.prototype.onMouseMove = function(location) {
 ...
 */
TutorialScreen5.prototype.onKeyDown = function(keyCode) {
